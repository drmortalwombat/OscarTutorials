...
const char NumberFont[] = {
	#embed ctm_chars lzo "../Resources/pertilecolor.ctm"
};

// The tile map, a 16x16 grid of 8 bit tile indices
const char NumberMap[] = {
	#embed ctm_map8 "../Resources/pertilecolor.ctm"
};

// The tiles, an array of 4x4 char indices
const char NumberTiles[] = {
	#embed ctm_tiles8 "../Resources/pertilecolor.ctm"
};

const char NumberAttr[] = {
	#embed ctm_attr1 "../Resources/pertilecolor.ctm"
};
